...
"""
BCC再開可能ポリゴンアノテーションツール
途中で終了しても進行状況を保存して再開可能
"""
    ...
    def annotate_bcc_files(self):
        ...
        while file_index < len(self.bcc_files):
            ...
            while True:
                ...
                cv2.putText(display_image, bcc_text, (10, 60), 
                          cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
                
                if self.current_polygon:
                    vertex_text = f"Points: {len(self.current_polygon)}"
                    cv2.putText(display_image, vertex_text, (10, 90), 
